...
STATS_TXT = os.path.join(OUTPUTS_DIR, "dense_16var_4d_epi_unified_results.txt")
HISTOGRAM_PDF = os.path.join(OUTPUTS_DIR, "dense_16var_4d_epi_histograms.pdf")

# ============================================================================
# TEST DATA GENERATION
# ============================================================================

def random_dense_output_values_16var(density):
    """
...
def analyze_dense_kmaps_4d_epis(density):
    ...
    print(f"Generating and analyzing {NUM_TEST_CASES} 16-variable K-maps at {density*100:.0f}% density...")
    print("=" * 70)
    ...
    for test_num in range(1, NUM_TEST_CASES + 1):
        ...
        output_values = random_dense_output_values_16var(density)
...
def create_histograms_pdf(all_results, all_stats):
    ...
    with PdfPages(HISTOGRAM_PDF) as pdf:
        for density in DENSITIES:
            ...
            ax.set_title(f'16-Variable Functions ({density*100:.0f}% density, N={len(results)})', 
...
def save_unified_statistics_txt(all_stats, all_results):
    ...
    with open(STATS_TXT, 'w') as f:
        f.write("="*80 + "\n")
        f.write("  DENSE 16-VARIABLE 4D EPI ANALYSIS - UNIFIED RESULTS\n")
        f.write("="*80 + "\n\n")
...
def main():
    ...
    print("\n" + "=" * 70)
    print("DENSE 16-VARIABLE 4D EPI ANALYSIS - MULTIPLE DENSITIES")
    print("=" * 70)
    ...
    for density in DENSITIES:
        print("\n" + "=" * 70)
        print(f"ANALYZING 16-VARIABLE K-MAPS AT {density*100:.0f}% DENSITY")
        print("=" * 70)
