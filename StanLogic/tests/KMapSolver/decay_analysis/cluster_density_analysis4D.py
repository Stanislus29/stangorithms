...
RESULTS_CSV = os.path.join(OUTPUTS_DIR, "cluster_density_analysis_4D.csv")
REPORT_PDF = os.path.join(OUTPUTS_DIR, "cluster_density_report_4D.pdf")
LOGO_PATH = os.path.join(SCRIPT_DIR, "..", "..", "..", "images", "St_logo_light-tp.png")

os.makedirs(OUTPUTS_DIR, exist_ok=True)

# Test configuration
VARIABLE_RANGE = range(9, 17)  # 9 to 16 variables (range is exclusive of endpoint)
