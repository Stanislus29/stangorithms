"""BoolMinGeo Decay Analysis: 11-13 Variable Boolean Minimization
===============================================================

DECAY STUDY: Performance degradation beyond 10-variable threshold

This benchmark demonstrates the decay in four-dimensional minimization 
performance beyond 10 variables, where geometric advantages are eliminated:
- Execution time degradation (11-13 variables)
...
VAR_RANGE = range(11, 14)    # 9-16 variables

# Output paths
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
OUTPUTS_DIR = os.path.join(SCRIPT_DIR, "..", "outputs","benchmark_results4D")
RESULTS_CSV = os.path.join(OUTPUTS_DIR, "4D_decay.csv")
REPORT_PDF = os.path.join(OUTPUTS_DIR, "4D_decay.pdf")
...
def document_experimental_setup():
    ...
    setup_info = {
        ...
        "study_type": "Decay Analysis: 4D minimization beyond 10 variables",
    }
    return setup_info
...
EXECUTIVE SUMMARY
{'-'*70}
This performance characterization study evaluated decay in 4D minimization showing that geometric advantages
in the fourth dimension are eliminated beyond 10-variables
...
def main():
    print("="*80)
    print("BoolMinGeo Decay Analysis: 4D Minimization Beyond 10 Variables")
    print("="*80)
    print("\nSTUDY OBJECTIVE: Demonstrate performance decay in 4D minimization")
    print("                 beyond 10-variable threshold (11-13 variables)\n")
    ...
    with PdfPages(REPORT_PDF) as pdf:
        ...
        ax.text(0.5, 0.52, 'Decay Analysis: 4D Minimization Beyond 10 Variables', fontsize=22, ha='center')
...
STUDY INFORMATION
{'─'*70}
Study Type:        Decay Analysis (4D minimization beyond 10 vars)
...
STUDY OBJECTIVE
{'─'*70}
This study demonstrates performance decay in 4-dimensional 
minimization beyond 10 variables, where the geometric advantages
of four-dimensional K-map visualization are eliminated.
...
To reproduce this experiment:
  ...
  4. Execute: python benchmark_test4D_decay.py
"""
    ...
    print(f"\nConclusion: Performance decay observed in 4D minimization")
    print(f"            beyond 10-variable threshold.")
