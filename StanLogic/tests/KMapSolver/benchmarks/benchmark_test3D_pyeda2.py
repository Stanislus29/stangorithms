...
OUTPUTS_DIR = os.path.join(SCRIPT_DIR, "..", "outputs", "benchmark_results3D_pyeda2")
RESULTS_CSV = os.path.join(OUTPUTS_DIR, "benchmark_results3D_pyeda.csv")
REPORT_PDF = os.path.join(OUTPUTS_DIR, "benchmark_scientific_report3D_pyeda.pdf")
...
Configurations Tested:   {len(all_stats)} (5-8 variables)
