...
This benchmark characterizes KMapSolver3D's hierarchical minimization method:
...
VAR_RANGE = range(9, 17)    # 9-16 variables (17 is exclusive)

# Output paths
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
OUTPUTS_DIR = os.path.join(SCRIPT_DIR, "..", "outputs", "benchmark_hierarchical_9to16")
RESULTS_CSV = os.path.join(OUTPUTS_DIR, "BoolMinGeo_hierarchical.csv")
REPORT_PDF = os.path.join(OUTPUTS_DIR, "BoolMinGeo_hierarchical.pdf")
