...
OUTPUTS_DIR = os.path.join(SCRIPT_DIR, "..", "outputs", "benchmark_results3D_sympy")
RESULTS_CSV = os.path.join(OUTPUTS_DIR, "benchmark_results3D_sympy.csv")
REPORT_PDF = os.path.join(OUTPUTS_DIR, "benchmark_results3D_sympy.pdf")
STATS_CSV = os.path.join(OUTPUTS_DIR, "benchmark_results3D_sympy_statistical_analysis.csv")
